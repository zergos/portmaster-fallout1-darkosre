...
2. Go to `docker` directory and run `build.sh`
3. Copy `docker/out/fallout-ce` to `fallout1-pm/fallout`
4. And don't forget to copy your original game data files (master, critter etc.)
